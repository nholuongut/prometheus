...
#
#  https://github.com/nholuongut/prometheus
#
...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/nholuongut/prometheus repo && cd repo && make
#
# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/nholuongut/prometheus repo && cd repo && make
#
# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/nholuongut/prometheus repo && cd repo && make
...
#    $(MAKE) pycompile
#    @echo
#    @echo 'BUILD SUCCESSFUL (Prometheus)'
